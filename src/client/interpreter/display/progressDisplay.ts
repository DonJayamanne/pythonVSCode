...
@injectable()
export class InterpreterLocatorProgressStatubarHandler
    implements InterpreterLocatorProgressHandler {
    ...
    public register() {
        this.progressService.onRefreshing(
            () => this.showProgress(),
            this,
            this.disposables
        );
        this.progressService.onRefreshed(
            () => this.hideProgress(),
            this,
            this.disposables
        );
    ...
    private createProgress() {
        const progressOptions: ProgressOptions = {
            ...
            title: this.isFirstTimeLoadingInterpreters
                ? Common.loadingExtension()
