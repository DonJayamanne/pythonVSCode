...
@injectable()
export class InterpreterAutoSeletionProxyService
    implements IInterpreterAutoSeletionProxyService {
    ...
    constructor(
        ...
        private readonly disposables: IAsyncDisposableRegistry
    ) {}
    public registerInstance(
        instance: IInterpreterAutoSeletionProxyService
    ): void {
