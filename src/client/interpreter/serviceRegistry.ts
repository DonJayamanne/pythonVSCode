...
} from "./locators/services/currentPathService";
import {
...
} from "./locators/services/KnownPathsService";
...
export function registerTypes(serviceManager: IServiceManager) {
    ...
    serviceManager.addSingleton<IInterpreterVersionService>(
        IInterpreterVersionService,
    ...
    serviceManager.addSingleton<IShebangCodeLensProvider>(
        IShebangCodeLensProvider,
    ...
    serviceManager.addSingleton<IInterpreterLocatorHelper>(
        IInterpreterLocatorHelper,
    ...
    serviceManager.addSingleton<InterpreterLocatorProgressHandler>(
        InterpreterLocatorProgressHandler,
