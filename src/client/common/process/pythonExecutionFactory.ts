...
import { createPythonEnv } from './pythonEnvironment';
...
export class PythonExecutionFactory implements IPythonExecutionFactory {
    ...
    public async create(options: ExecutionFactoryCreationOptions): Promise<IPythonExecutionService> {
        const pythonPath = options.pythonPath ? options.pythonPath : 'python';
    ...
    public async createDaemon<T extends IPythonDaemonExecutionService | IDisposable>(
        ...
        const interpreter = interpreterService ? await interpreterService.getInterpreterDetails(pythonPath) : undefined;
    ...
    public async createActivatedEnvironment(
        ...
        const pythonPath = options.interpreter ? options.interpreter.path : 'python';
...
function createPythonService(
    ...
    const env = createPythonEnv(pythonPath, procService, fs);
