...
@injectable()
export class PowershellTerminalActivationFailedHandler
    ...
    public async handleActivation(
        ...
        const shell = this.helper.identifyTerminalShell(
            this.helper.getTerminalShellPath()
        );
        if (
        ...
        this.diagnosticService
            .handle([new PowershellActivationNotAvailableDiagnostic()])
            .ignoreErrors();
    }
}
