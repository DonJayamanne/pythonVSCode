...
export class ConfigurationService implements IConfigurationService {
    ...
    public getSettings(resource?: Uri): IPythonSettings {
        const InterpreterAutoSelectionService = this.serviceContainer.get<
    ...
    public async updateSectionSetting(
        ...
        if (
            ...
            ((settingsInfo.target === ConfigurationTarget.Global &&
                currentValue.globalValue === value) ||
                (settingsInfo.target === ConfigurationTarget.Workspace &&
