...
export namespace Diagnostics {
    ...
    export const warnBeforeEnablingSourceMaps = localize(
        ...
        'Enabling source map support in the Jupyter Extension will adversely impact performance of the extension.'
    );
