...
export namespace Diagnostics {
    ...
    export const disableSourceMaps = localize(
    ...
    export const lsNotSupported = localize(
        ...
        "Your operating system does not meet the minimum requirements of the Language Server. Reverting to the alternative, Jedi."
    );
...
export namespace Common {
    ...
    export const loadingExtension = localize(
        "Common.loadingPythonExtension",
        "Python extension loading..."
    );
    export const openOutputPanel = localize(
...
export namespace LanguageService {
    ...
    export const bannerLabelYes = localize(
        "LanguageService.bannerLabelYes",
        "Yes, take survey now"
    );
    export const bannerLabelNo = localize(
...
export namespace Interpreters {
    export const loading = localize(
        "Interpreters.LoadingInterpreters",
        "Loading Python Interpreters"
    );
    export const refreshing = localize(
        "Interpreters.RefreshingInterpreters",
        "Refreshing Python Interpreters"
    );
}

export namespace Linters {
    export const installedButNotEnabled = localize(
        "Linter.InstalledButNotEnabled",
        "Linter {0} is installed but not enabled."
    );
...
export namespace DataScienceSurveyBanner {
    ...
    export const bannerLabelYes = localize(
        "DataScienceSurveyBanner.bannerLabelYes",
        "Yes, take survey now"
    );
    export const bannerLabelNo = localize(
...
export namespace DataScience {
    export const historyTitle = localize(
        "DataScience.historyTitle",
        "Python Interactive"
    );
    ...
    export const exportDialogComplete = localize(
        "DataScience.exportDialogComplete",
        "Notebook written to {0}"
    );
    export const exportDialogFailed = localize(
        "DataScience.exportDialogFailed",
        "Failed to export notebook. {0}"
    );
    export const exportOpenQuestion = localize(
        "DataScience.exportOpenQuestion",
        "Open in browser"
    );
    export const runCellLensCommandTitle = localize(
    ...
    export const importDialogFilter = localize(
    ...
    export const notebookCheckForImportYes = localize(
        "DataScience.notebookCheckForImportYes",
        "Import"
    );
    export const notebookCheckForImportNo = localize(
    ...
    export const importingFormat = localize(
        "DataScience.importingFormat",
        "Importing {0}"
    );
    export const startingJupyter = localize(
        "DataScience.startingJupyter",
        "Starting Jupyter server"
    );
    export const connectingToJupyter = localize(
        "DataScience.connectingToJupyter",
        "Connecting to Jupyter server"
    );
    export const exportingFormat = localize(
    ...
    export const restartKernelMessageYes = localize(
        "DataScience.restartKernelMessageYes",
        "Restart"
    );
    export const restartKernelMessageNo = localize(
        "DataScience.restartKernelMessageNo",
        "Cancel"
    );
    export const restartingKernelStatus = localize(
        "DataScience.restartingKernelStatus",
        "Restarting iPython Kernel"
    );
    export const executingCode = localize(
        "DataScience.executingCode",
        "Executing Cell"
    );
    export const collapseAll = localize(
        "DataScience.collapseAll",
        "Collapse all cell inputs"
    );
    export const expandAll = localize(
        "DataScience.expandAll",
        "Expand all cell inputs"
    );
    export const exportKey = localize(
        "DataScience.export",
        "Export as Jupyter Notebook"
    );
    export const restartServer = localize(
    ...
    export const clearAll = localize(
        "DataScience.clearAll",
        "Remove All Cells"
    );
    export const pythonVersionHeader = localize(
        "DataScience.pythonVersionHeader",
        "Python Version:"
    );
    export const pythonRestartHeader = localize(
        "DataScience.pythonRestartHeader",
        "Restarted Kernel:"
    );
    export const pythonVersionHeaderNoPyKernel = localize(
        "DataScience.pythonVersionHeaderNoPyKernel",
        "Python Version may not match, no ipykernel found:"
    );

    export const jupyterSelectURILaunchLocal = localize(
        "DataScience.jupyterSelectURILaunchLocal",
        "Launch local Jupyter server"
    );
    export const jupyterSelectURISpecifyURI = localize(
        "DataScience.jupyterSelectURISpecifyURI",
        "Type in the URI for the Jupyter server"
    );
    export const jupyterSelectURIPrompt = localize(
        "DataScience.jupyterSelectURIPrompt",
        "Enter the URI of a Jupyter server"
    );
    ...
    export const interruptKernel = localize(
        "DataScience.interruptKernel",
        "Interrupt iPython Kernel"
    );
    export const interruptKernelStatus = localize(
        "DataScience.interruptKernelStatus",
        "Interrupting iPython Kernel"
    );
    ...
    export const sysInfoURILabel = localize(
        "DataScience.sysInfoURILabel",
        "Jupyter Server URI: "
    );
}
...
export namespace UnitTests {
    export const testErrorDiagnosticMessage = localize(
        "UnitTests.testErrorDiagnosticMessage",
        "Error"
    );
    export const testFailDiagnosticMessage = localize(
        "UnitTests.testFailDiagnosticMessage",
        "Fail"
    );
    export const testSkippedDiagnosticMessage = localize(
        "UnitTests.testSkippedDiagnosticMessage",
        "Skipped"
    );
}
