...
export namespace Common {
    ...
    export const loadingExtension = localize('Common.loadingPythonExtension', 'Jupyter extension loading...');
...
export namespace DataScience {
    ...
    export const interactiveWindowModeBannerTitle = localize(
        ...
        'Do you want to open a new Python Interactive window for this file? [More Information](command:workbench.action.openSettings?%5B%22jupyter.datascience.interactiveWindowMode%22%5D).'
    );
    ...
    export const runCellLensCommandTitle = localize('python.command.jupyter.datascience.runcell.title', 'Run cell');
    ...
    export const runAllCellsLensCommandTitle = localize(
        'python.command.jupyter.datascience.runallcells.title',
        'Run all cells'
    );
    export const runAllCellsAboveLensCommandTitle = localize(
        'python.command.jupyter.datascience.runallcellsabove.title',
        'Run above'
    );
    export const runCellAndAllBelowLensCommandTitle = localize(
        'python.command.jupyter.datascience.runcellandallbelow.title',
        'Run Below'
    );
    ...
    export const gatheredNotebookDescriptionInMarkdown = localize(
        ...
        '# Gathered Notebook\nGathered from ```{0}```\n\n|   |   |\n|---|---|\n|&nbsp;&nbsp;&nbsp|This notebook was generated by the Gather Extension. It requires version 2020.7.94776 (or newer) of the Python Extension, please update [here](https://command:jupyter.datascience.latestExtension). The intent is that it contains only the code and cells required to produce the same results as the cell originally selected for gathering. Please note that the Python analysis is quite conservative, so if it is unsure whether a line of code is necessary for execution, it will err on the side of including it.|\n\n**Are you satisfied with the code that was gathered?**\n\n[Yes](https://command:jupyter.datascience.gatherquality?yes) [No](https://command:jupyter.datascience.gatherquality?no)'
    );
    ...
    export const trimmedOutput = localize(
        ...
        'Output was trimmed for performance reasons.\nTo see the full output set the setting "jupyter.datascience.textOutputLimit" to 0.'
    );
    ...
    export const loadThirdPartyWidgetScriptsPostEnabled = localize(
        ...
        "Please restart the Kernel when changing the setting 'jupyter.datascience.widgetScriptSources'."
    );
    ...
    export const enableCDNForWidgetsSetting = localize(
        ...
        "Widgets require us to download supporting files from a 3rd party website. Click <a href='https://command:jupyter.datascience.enableLoadingWidgetScriptsFromThirdPartySource'>here</a> to enable this or click <a href='https://aka.ms/PVSCIPyWidgets'>here</a> for more information. (Error loading {0}:{1})."
    );
