...
export class NoDebugLauncherScriptProvider
    implements IDebugLauncherScriptProvider<LocalDebugOptions> {
    public getLauncherArgs(options: LocalDebugOptions): string[] {
        const customDebugger = options.customDebugger
            ? "--custom"
            : "--default";
        return [
            script,
...
export class DebuggerLauncherScriptProvider
    implements IDebugLauncherScriptProvider<LocalDebugOptions> {
    public getLauncherArgs(options: LocalDebugOptions): string[] {
        const customDebugger = options.customDebugger
            ? "--custom"
...
export class RemoteDebuggerLauncherScriptProvider
