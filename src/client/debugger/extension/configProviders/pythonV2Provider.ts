...
export class PythonV2DebugConfigurationProvider extends BaseConfigurationProvider {
    ...
    private isDebuggingFlask(debugConfiguration: Partial<LaunchRequestArguments> | Partial<AttachRequestArguments>) {
        return (debugConfiguration.module && debugConfiguration.module.toUpperCase() === 'FLASK') ? true : false;
    }
    private sendTelemetry(trigger: 'launch' | 'attach', debugConfiguration: Partial<LaunchRequestArguments> | Partial<AttachRequestArguments>) {
