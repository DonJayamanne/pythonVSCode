...
export function registerTypes(serviceManager: IServiceManager) {
    ...
    serviceManager.add<IExtensionActivator>(
        IExtensionActivator,
    ...
    serviceManager.addSingleton<ILanguageClientFactory>(
        ILanguageClientFactory,
        BaseLanguageClientFactory,
        LanguageClientFactory.base
    );
    serviceManager.addSingleton<ILanguageClientFactory>(
        ILanguageClientFactory,
        DownloadedLanguageClientFactory,
    ...
    serviceManager.addSingleton<ILanguageClientFactory>(
        ILanguageClientFactory,
        SimpleLanguageClientFactory,
        LanguageClientFactory.simple
    );
    serviceManager.addSingleton<IInterpreterDataService>(
        IInterpreterDataService,
        InterpreterDataService
    );
    serviceManager.addSingleton<ILanguageServerDownloader>(
        ILanguageServerDownloader,
