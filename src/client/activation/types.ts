...
export const ILanguageServerFolderService = Symbol(
...
export const ILanguageServerPackageService = Symbol(
...
export interface IDownloadChannelRule {
    shouldLookForNewLanguageServer(
        currentFolder?: FolderVersionPair
    ): Promise<boolean>;
}
export const ILanguageServerCompatibilityService = Symbol(
