...
import { getCellTextForIPyKernelExecution } from '../../notebook/helpers/cellMagicHelper';
import {
...
export class CellExecution {
    ...
    private canExecuteCell() {
        ...
        // Possible we have a cell such as html, perl or the like (magics in cells).
        const code = this.isPythonKernelConnection
            ? getCellTextForIPyKernelExecution(this.cell)
