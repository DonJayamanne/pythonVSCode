...
export namespace Commands {
    export const RunAllCells = 'jupyter.datascience.runallcells';
    export const RunAllCellsAbove = 'jupyter.datascience.runallcellsabove';
    export const RunCellAndAllBelow = 'jupyter.datascience.runcellandallbelow';
    export const SetJupyterKernel = 'jupyter.datascience.setKernel';
    export const SwitchJupyterKernel = 'jupyter.datascience.switchKernel';
    export const RunAllCellsAbovePalette = 'jupyter.datascience.runallcellsabove.palette';
    export const RunCellAndAllBelowPalette = 'jupyter.datascience.runcurrentcellandallbelow.palette';
    export const RunToLine = 'jupyter.datascience.runtoline';
    export const RunFromLine = 'jupyter.datascience.runfromline';
    export const RunCell = 'jupyter.datascience.runcell';
    export const RunCurrentCell = 'jupyter.datascience.runcurrentcell';
    export const RunCurrentCellAdvance = 'jupyter.datascience.runcurrentcelladvance';
    export const CreateNewInteractive = 'jupyter.datascience.createnewinteractive';
    export const ImportNotebook = 'jupyter.datascience.importnotebook';
    export const ImportNotebookFile = 'jupyter.datascience.importnotebookfile';
    export const OpenNotebook = 'jupyter.datascience.opennotebook';
    export const OpenNotebookInPreviewEditor = 'jupyter.datascience.opennotebookInPreviewEditor';
    export const SelectJupyterURI = 'jupyter.datascience.selectjupyteruri';
    export const SelectJupyterCommandLine = 'jupyter.datascience.selectjupytercommandline';
    export const ExportFileAsNotebook = 'jupyter.datascience.exportfileasnotebook';
    export const ExportFileAndOutputAsNotebook = 'jupyter.datascience.exportfileandoutputasnotebook';
    export const UndoCells = 'jupyter.datascience.undocells';
    export const RedoCells = 'jupyter.datascience.redocells';
    export const RemoveAllCells = 'jupyter.datascience.removeallcells';
    export const InterruptKernel = 'jupyter.datascience.interruptkernel';
    export const RestartKernel = 'jupyter.datascience.restartkernel';
    export const NotebookEditorUndoCells = 'jupyter.datascience.notebookeditor.undocells';
    export const NotebookEditorRedoCells = 'jupyter.datascience.notebookeditor.redocells';
    export const NotebookEditorRemoveAllCells = 'jupyter.datascience.notebookeditor.removeallcells';
    export const NotebookEditorInterruptKernel = 'jupyter.datascience.notebookeditor.interruptkernel';
    export const NotebookEditorRestartKernel = 'jupyter.datascience.notebookeditor.restartkernel';
    export const NotebookEditorRunAllCells = 'jupyter.datascience.notebookeditor.runallcells';
    export const NotebookEditorRunSelectedCell = 'jupyter.datascience.notebookeditor.runselectedcell';
    export const NotebookEditorAddCellBelow = 'jupyter.datascience.notebookeditor.addcellbelow';
    export const ExpandAllCells = 'jupyter.datascience.expandallcells';
    export const CollapseAllCells = 'jupyter.datascience.collapseallcells';
    export const ExportOutputAsNotebook = 'jupyter.datascience.exportoutputasnotebook';
    export const ExecSelectionInInteractiveWindow = 'jupyter.datascience.execSelectionInteractive';
    export const RunFileInInteractiveWindows = 'jupyter.datascience.runFileInteractive';
    export const DebugFileInInteractiveWindows = 'jupyter.datascience.debugFileInteractive';
    export const AddCellBelow = 'jupyter.datascience.addcellbelow';
    export const DebugCurrentCellPalette = 'jupyter.datascience.debugcurrentcell.palette';
    export const DebugCell = 'jupyter.datascience.debugcell';
    export const DebugStepOver = 'jupyter.datascience.debugstepover';
    export const DebugContinue = 'jupyter.datascience.debugcontinue';
    export const DebugStop = 'jupyter.datascience.debugstop';
    export const RunCurrentCellAndAddBelow = 'jupyter.datascience.runcurrentcellandaddbelow';
    export const InsertCellBelowPosition = 'jupyter.datascience.insertCellBelowPosition';
    export const InsertCellBelow = 'jupyter.datascience.insertCellBelow';
    export const InsertCellAbove = 'jupyter.datascience.insertCellAbove';
    export const DeleteCells = 'jupyter.datascience.deleteCells';
    export const SelectCell = 'jupyter.datascience.selectCell';
    export const SelectCellContents = 'jupyter.datascience.selectCellContents';
    export const ExtendSelectionByCellAbove = 'jupyter.datascience.extendSelectionByCellAbove';
    export const ExtendSelectionByCellBelow = 'jupyter.datascience.extendSelectionByCellBelow';
    export const MoveCellsUp = 'jupyter.datascience.moveCellsUp';
    export const MoveCellsDown = 'jupyter.datascience.moveCellsDown';
    export const ChangeCellToMarkdown = 'jupyter.datascience.changeCellToMarkdown';
    export const ChangeCellToCode = 'jupyter.datascience.changeCellToCode';
    export const GotoNextCellInFile = 'jupyter.datascience.gotoNextCellInFile';
    export const GotoPrevCellInFile = 'jupyter.datascience.gotoPrevCellInFile';
    export const ScrollToCell = 'jupyter.datascience.scrolltocell';
    export const CreateNewNotebook = 'jupyter.datascience.createnewnotebook';
    export const ViewJupyterOutput = 'jupyter.datascience.viewJupyterOutput';
    export const ExportAsPythonScript = 'jupyter.datascience.exportAsPythonScript';
    export const ExportToHTML = 'jupyter.datascience.exportToHTML';
    export const ExportToPDF = 'jupyter.datascience.exportToPDF';
    export const Export = 'jupyter.datascience.export';
    export const SaveNotebookNonCustomEditor = 'jupyter.datascience.notebookeditor.save';
    export const SaveAsNotebookNonCustomEditor = 'jupyter.datascience.notebookeditor.saveAs';
    export const OpenNotebookNonCustomEditor = 'jupyter.datascience.notebookeditor.open';
    export const GatherQuality = 'jupyter.datascience.gatherquality';
    export const LatestExtension = 'jupyter.datascience.latestExtension';
    export const TrustNotebook = 'jupyter.datascience.notebookeditor.trust';
    export const EnableLoadingWidgetsFrom3rdPartySource =
        'jupyter.datascience.enableLoadingWidgetScriptsFromThirdPartySource';
    export const NewNotebookRemoveAllCells = 'jupyter.datascience.newNotebook.removeallcells';
    export const NewNotebookExpandAllCells = 'jupyter.datascience.newNotebook.expandallcells';
    export const NewNotebookCollapseAllCells = 'jupyter.datascience.newNotebook.collapseallcells';
}
...
export namespace EditorContexts {
    export const HasCodeCells = 'jupyter.datascience.hascodecells';
    export const DataScienceEnabled = 'jupyter.datascience.featureenabled';
    export const HaveInteractiveCells = 'jupyter.datascience.haveinteractivecells';
    export const HaveRedoableCells = 'jupyter.datascience.haveredoablecells';
    export const HaveInteractive = 'jupyter.datascience.haveinteractive';
    export const IsInteractiveActive = 'jupyter.datascience.isinteractiveactive';
    export const OwnsSelection = 'jupyter.datascience.ownsSelection';
    export const HaveNativeCells = 'jupyter.datascience.havenativecells';
    export const HaveNativeRedoableCells = 'jupyter.datascience.havenativeredoablecells';
    export const HaveNative = 'jupyter.datascience.havenative';
    export const IsNativeActive = 'jupyter.datascience.isnativeactive';
    export const IsInteractiveOrNativeActive = 'jupyter.datascience.isinteractiveornativeactive';
    export const IsPythonOrNativeActive = 'jupyter.datascience.ispythonornativeactive';
    export const IsPythonOrInteractiveActive = 'jupyter.datascience.ispythonorinteractiveeactive';
    export const IsPythonOrInteractiveOrNativeActive = 'jupyter.datascience.ispythonorinteractiveornativeeactive';
    export const HaveCellSelected = 'jupyter.datascience.havecellselected';
    export const IsNotebookTrusted = 'jupyter.datascience.isnotebooktrusted';
    export const CanRestartNotebookKernel = 'jupyter.datascience.notebookeditor.canrestartNotebookkernel';
}
...
export namespace Settings {
    ...
    export const JupyterServerUriList = 'jupyter.datascience.jupyterServer.uriList';
