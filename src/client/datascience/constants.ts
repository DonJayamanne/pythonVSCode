...
export namespace Commands {
    ...
    export const RunCurrentCellAdvance =
    ...
    export const ExportOutputAsNotebook =
...
export namespace EditorContexts {
    ...
    export const HaveInteractiveCells =
        "python.datascience.haveinteractivecells";
...
export namespace RegExpValues {
    export const PythonCellMarker = new RegExp(
...
export namespace Telemetry {
    ...
    export const RunCurrentCellAndAdvance =
    ...
    export const SetJupyterURIToUserSpecified =
    ...
    export const ExportPythonFileAndOutput =
