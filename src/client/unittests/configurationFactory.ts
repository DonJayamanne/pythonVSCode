...
@injectable()
export class TestConfigurationManagerFactory
    implements ITestConfigurationManagerFactory {
    constructor(
    ...
    public create(wkspace: Uri, product: Product) {
        switch (product) {
            case Product.unittest: {
                return new unittest.ConfigurationManager(
                    wkspace,
            ...
            case Product.nosetest: {
                return new nose.ConfigurationManager(
                    wkspace,
                    this.serviceContainer
                );
            }
