...
export class UnitTestDiagnosticService implements IUnitTestDiagnosticService {
    ...
    private MessageSeverities = new Map<
        PythonUnitTestMessageSeverity,
        DiagnosticSeverity
    >();
    ...
    constructor() {
        ...
        this.MessagePrefixes.set(
            DiagnosticMessageType.Error,
            localize.UnitTests.testErrorDiagnosticMessage()
        );
        this.MessagePrefixes.set(
            DiagnosticMessageType.Fail,
            localize.UnitTests.testFailDiagnosticMessage()
        );
        this.MessagePrefixes.set(
            DiagnosticMessageType.Skipped,
            localize.UnitTests.testSkippedDiagnosticMessage()
        );
    ...
    public getSeverity(
        unitTestSeverity: PythonUnitTestMessageSeverity
    ): DiagnosticSeverity {
