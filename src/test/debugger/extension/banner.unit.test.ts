...
import {
    DebuggerBanner,
    PersistentStateKeys
} from "../../../client/debugger/extension/banner";
...
suite("Debugging - Banner", () => {
    ...
    let launchThresholdCounterState: typemoq.IMock<
        IPersistentState<number | undefined>
    >;
    ...
    setup(() => {
        ...
        factory
            .setup(f =>
                f.createGlobalPersistentState(
                    typemoq.It.isValue(
                        PersistentStateKeys.DebuggerLaunchCounter
                    ),
                    typemoq.It.isAny()
                )
            )
        ...
        factory
            .setup(f =>
                f.createGlobalPersistentState(
                    typemoq.It.isValue(PersistentStateKeys.ShowBanner),
                    typemoq.It.isAny()
                )
            )
        ...
        factory
            .setup(f =>
                f.createGlobalPersistentState(
                    typemoq.It.isValue(
                        PersistentStateKeys.DebuggerLaunchThresholdCounter
                    ),
                    typemoq.It.isAny()
                )
            )
        ...
        factory
            .setup(f =>
                f.createGlobalPersistentState(
                    typemoq.It.isValue(PersistentStateKeys.UserSelected),
                    typemoq.It.isAny()
                )
            )
        ...
        serviceContainer
            .setup(s => s.get(typemoq.It.isValue(IDebugService)))
            .returns(() => debugService.object);
        serviceContainer
            .setup(s => s.get(typemoq.It.isValue(ILogger)))
            .returns(() => logger.object);
        serviceContainer
            .setup(s => s.get(typemoq.It.isValue(IDisposableRegistry)))
            .returns(() => []);
        serviceContainer
            .setup(s => s.get(typemoq.It.isValue(IApplicationShell)))
            .returns(() => appShell.object);
        serviceContainer
            .setup(s => s.get(typemoq.It.isValue(IRandom)))
    ...
    test("Increment Debugger Launch Counter when debug session starts", async () => {
        ...
        launchCounterState
            .setup(l =>
                l.updateValue(typemoq.It.isValue(debuggerLaunchCounter + 1))
            )
            .verifiable(typemoq.Times.once());
        showBannerState
            .setup(s => s.value)
    ...
    test("show must be invoked when shouldShow returns true", async () => {
        ...
        launchCounterState
            .setup(l =>
                l.updateValue(typemoq.It.isValue(currentLaunchCounter + 1))
            )
            .returns(() => Promise.resolve())
            .verifiable(typemoq.Times.atLeastOnce());
