                    ...
                    getNamesAndValues<TerminalShellType>(
                        ...
                        switch (shellType.value) {
                            ...
                            case TerminalShellType.bash: {
                                isScriptFileSupported =
                                    ["activate", "activate.sh"].indexOf(
                                        scriptFileName
                                    ) >= 0;
                                break;
                            }
                            case TerminalShellType.fish: {
                                isScriptFileSupported =
                                    ["activate.fish"].indexOf(scriptFileName) >=
                                    0;
                                break;
                            }
                            ...
                            case TerminalShellType.cshell: {
                                isScriptFileSupported =
                                    ["activate.csh"].indexOf(scriptFileName) >=
                                    0;
                                break;
                            }
                            default: {
                        ...
                        const titleTitle = isScriptFileSupported
                            ? `Ensure bash Activation command returns activation command (Shell: ${
                                  shellType.name
                              })`
                            : `Ensure bash Activation command returns undefined (Shell: ${
                                  shellType.name
                              })`;
                        ...
                        test(titleTitle, async () => {
                            ...
                            fileSystem
                                .setup(fs =>
                                    fs.fileExists(
                                        TypeMoq.It.isValue(pathToScriptFile)
                                    )
                                )
