...
suite('Interpreters from Conda Environments', () => {
    ...
    test('Must return an empty list for empty json', async () => {
        const condaProvider = new CondaEnvService(new CondaLocatorService(IS_WINDOWS, processServiceFactory), new MockInterpreterVersionProvider(''), processServiceFactory);
    ...
    test('Must detect conda environments from a list', async () => {
        ...
        const condaProvider = new CondaEnvService(new CondaLocatorService(true, processServiceFactory, mockRegistryProvider), new MockInterpreterVersionProvider(''), processServiceFactory);
    ...
    test('Must use Conda env from Registry to locate conda.exe', async () => {
        ...
        const mockRegistryProvider = new MockProvider(registryInterpreters);
        const condaProvider = new MockCondaLocatorService(true, processServiceFactory, mockRegistryProvider, false);
