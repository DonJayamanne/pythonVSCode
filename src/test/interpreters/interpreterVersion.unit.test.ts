...
suite("Interpreters display version", () => {
    ...
    setup(() => {
        ...
        interpreterVersionService = new InterpreterVersionService(
    ...
    test("Must return the Python Version", async () => {
        ...
        const pyVersion = await interpreterVersionService.getVersion(
            pythonPath,
            "DEFAULT_TEST_VALUE"
        );
    ...
    test("Must return the pip Version.", async () => {
        ...
        const pyVersion = await interpreterVersionService.getPipVersion(
            pythonPath
        );
    ...
    test("Must throw an exception when pip version cannot be determined", async () => {
        ...
        const pipVersionPromise = interpreterVersionService.getPipVersion(
            pythonPath
        );
