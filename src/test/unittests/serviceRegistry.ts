...
export class UnitTestIocContainer extends IocContainer {
    ...
    public async getPythonMajorVersion(resource: Uri): Promise<number> {
        const procServiceFactory = this.serviceContainer.get<
    ...
    public registerTestVisitors() {
        this.serviceManager.add<ITestVisitor>(
            ITestVisitor,
    ...
    public registerTestsHelper() {
        this.serviceManager.addSingleton<ITestsHelper>(
            ITestsHelper,
            TestsHelper
        );
    }
    ...
    public registerTestResultsHelper() {
        this.serviceManager.add<ITestResultsService>(
            ITestResultsService,
            TestResultsService
        );
    }
    ...
    public registerTestParsers() {
        this.serviceManager.add<ITestsParser>(
            ITestsParser,
            UnitTestTestsParser,
            UNITTEST_PROVIDER
        );
    ...
    public registerTestDiagnosticServices() {
        this.serviceManager.addSingleton<IUnitTestDiagnosticService>(
    ...
    public registerMockUnitTestSocketServer() {
        this.serviceManager.addSingleton<IUnitTestSocketServer>(
            IUnitTestSocketServer,
