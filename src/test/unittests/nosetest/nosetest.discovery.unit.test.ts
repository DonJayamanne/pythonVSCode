...
import { NOSETEST_PROVIDER } from "../../../client/unittests/common/constants";
import {
...
import { TestDiscoveryService } from "../../../client/unittests/nosetest/services/discoveryService";
...
suite("Unit Tests - nose - Discovery", () => {
    ...
    setup(() => {
        ...
        serviceContainer
            .setup(s =>
                s.get(typeMoq.It.isValue(IArgumentsService), typeMoq.It.isAny())
            )
    ...
    test("Ensure discovery is invoked with the right args", async () => {
        ...
        argsService
            .setup(a =>
                a.filterArguments(
                    ...
                    typeMoq.It.isValue(TestFilter.discovery)
                )
            )
            .returns(() => [])
        ...
        runner
            .setup(r =>
                r.run(typeMoq.It.isValue(NOSETEST_PROVIDER), typeMoq.It.isAny())
            )
