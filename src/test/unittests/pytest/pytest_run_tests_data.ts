...
export const allTestDetails: ITestDetails[] = [
    ...
    },
    {
        className: "tests.test_another_pytest",
        nameToRun:
            "tests/test_another_pytest.py::test_parametrized_username[one]",
        fileName: path.join(..."tests/test_another_pytest.py".split("/")),
    ...
    },
    {
        className: "tests.test_another_pytest",
        nameToRun:
            "tests/test_another_pytest.py::test_parametrized_username[two]",
        fileName: path.join(..."tests/test_another_pytest.py".split("/")),
    ...
    },
    {
        className: "tests.test_another_pytest",
        nameToRun:
            "tests/test_another_pytest.py::test_parametrized_username[three]",
        fileName: path.join(..."tests/test_another_pytest.py".split("/")),
    ...
    {
        className:
            "tests.test_foreign_nested_tests.TestNestedForeignTests.TestInheritingHere.()",
        nameToRun:
    ...
    },
    {
        ...
        nameToRun:
            "tests/test_foreign_nested_tests.py::TestNestedForeignTests::test_normal",
        fileName: path.join(..."tests/test_foreign_nested_tests.py".split("/")),
    ...
    },
    {
        ...
        nameToRun:
            "tests/test_pytest.py::Test_CheckMyApp::Test_NestedClassA::test_nested_class_methodB",
        fileName: path.join(..."tests/test_pytest.py".split("/")),
    ...
    {
        className:
            "tests.test_pytest.Test_CheckMyApp.Test_NestedClassA.().Test_nested_classB_Of_A.()",
        nameToRun:
    ...
    },
    {
        className: "tests.test_pytest.Test_CheckMyApp.Test_NestedClassA.()",
        nameToRun:
            "tests/test_pytest.py::Test_CheckMyApp::Test_NestedClassA::test_nested_class_methodC",
        fileName: path.join(..."tests/test_pytest.py".split("/")),
