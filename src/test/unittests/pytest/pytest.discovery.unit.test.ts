...
suite("Unit Tests - PyTest - Discovery", () => {
    ...
    setup(() => {
        ...
        serviceContainer
            .setup(s =>
                s.get(typeMoq.It.isValue(ITestsHelper), typeMoq.It.isAny())
            )
    ...
    test("Ensure discovery is invoked with the right args and single dir", async () => {
        ...
        argsService
            .setup(a => a.getTestFolders(typeMoq.It.isValue(args)))
            .returns(() => [dir])
            .verifiable(typeMoq.Times.once());
        helper
            .setup(a => a.mergeTests(typeMoq.It.isAny()))
            .returns(() => tests)
            .verifiable(typeMoq.Times.once());
        runner
            .setup(r =>
                r.run(typeMoq.It.isValue(PYTEST_PROVIDER), typeMoq.It.isAny())
            )
