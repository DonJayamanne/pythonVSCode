...
suite("Unit Tests - unittest - discovery with mocked process output", () => {
    ...
    `);
        ...
        assert.equal(
            tests.testFiles.some(
                t =>
                    t.name === "test_unittest_one.py" &&
                    t.nameToRun === "test_unittest_one.Test_test1.test_A"
            ),
            true,
            "Test File not found"
        );
        assert.equal(
            tests.testFiles.some(
                t =>
                    t.name === "test_unittest_two.py" &&
                    t.nameToRun === "test_unittest_two.Test_test2.test_A2"
            ),
            true,
            "Test File not found"
        );
    ...
    `);
        ...
        assert.equal(
            tests.testFiles.some(
                t =>
                    t.name === "unittest_three_test.py" &&
                    t.nameToRun === "unittest_three_test.Test_test3.test_A"
            ),
            true,
            "Test File not found"
        );
