...
suite("Unit Tests - Debug Launcher", () => {
    ...
    setup(async () => {
        ...
        serviceContainer
            .setup(c => c.get(TypeMoq.It.isValue(IDebugService)))
    ...
    function setupDebugManager(
        ...
        debugService
            .setup(d =>
                d.startDebugging(
                    TypeMoq.It.isValue(workspaceFolder),
    ...
    testProviders.forEach(testProvider => {
        ...
        test(`Must launch debugger ${testTitleSuffix}`, async () => {
            workspaceService
                .setup(u => u.hasWorkspaceFolders)
                .returns(() => true);
            const workspaceFolders = [
                createWorkspaceFolder("one/two/three"),
                createWorkspaceFolder("five/six/seven")
            ];
            workspaceService
                .setup(u => u.workspaceFolders)
                .returns(() => workspaceFolders);
            workspaceService
                .setup(u => u.getWorkspaceFolder(TypeMoq.It.isAny()))
            ...
            debugLauncher
                .launchDebugger({ cwd, args, testProvider })
                .ignoreErrors();
        ...
        test(`Must not launch debugger if cancelled ${testTitleSuffix}`, async () => {
            ...
            debugService
                .setup(d =>
                    d.startDebugging(TypeMoq.It.isAny(), TypeMoq.It.isAny())
                )
                .returns(() => Promise.resolve(undefined as any))
