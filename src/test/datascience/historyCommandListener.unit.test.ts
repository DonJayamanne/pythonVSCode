...
class MockDocumentManager implements IDocumentManager {
    ...
    private didChangeTextEditorSelectionEmitter = new EventEmitter<
        TextEditorSelectionChangeEvent
    >();
    private didChangeTextEditorOptionsEmitter = new EventEmitter<
        TextEditorOptionsChangeEvent
    >();
    private didChangeTextEditorViewColumnEmitter = new EventEmitter<
        TextEditorViewColumnChangeEvent
    >();
        ...
        server
            ...
            .returns(() => {
                return Promise.resolve(
                    generateCells("a=1", "bar.py", 0, false)
                );
            });
