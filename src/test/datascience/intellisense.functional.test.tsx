...
suite(`DataScience Intellisense tests with LanguageServer mocked`, () => {
    ...
    let snapshot: any;
    let mockLanguageServer: MockLanguageServer;
    ...
    setup(async () => {
        ...
        await ioc.activate();
        mockLanguageServer = (await ioc
            .get<ILanguageServerProvider>(ILanguageServerProvider)
            .getLanguageServer(undefined)) as MockLanguageServer;
    });
    ...
    InteractiveHelpers.runTest(
        ...
        async () => {
            ...
            // Force the next completion item
            mockLanguageServer.setNextCompletionItem({
                label: 'print'
            });
    ...
    InteractiveHelpers.runTest(
        ...
        async () => {
            ...
            if (interpreters.length > 1 && oldActive) {
                ...
                (interpreterService as InterpreterService).updateInterpreter(undefined, firstOther[0].path);
    ...
    NativeHelpers.runMountedTest('Hover on notebook', async () => {
        ...
        mockLanguageServer.setNextHover({
            contents: 'a=1\na'
        });
