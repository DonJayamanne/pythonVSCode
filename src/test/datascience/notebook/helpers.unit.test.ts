...
import { getDefaultNotebookContentForNativeNotebooks } from '../../../client/datascience/notebookStorage/baseModel';
...
suite('DataScience - NativeNotebook helpers', () => {
    test('Convert NotebookModel to VSCode NotebookData', async () => {
        ...
        const notebook = notebookModelToVSCNotebookData(
            true,
            {},
            Uri.file(''),
            cells,
            getDefaultNotebookContentForNativeNotebooks(PYTHON_LANGUAGE)!.metadata,
            PYTHON_LANGUAGE
        );
