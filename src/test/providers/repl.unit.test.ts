...
suite("REPL Provider", () => {
    ...
    setup(() => {
        ...
        serviceContainer
            .setup(c =>
                c.get(ICodeExecutionService, TypeMoq.It.isValue("repl"))
            )
    ...
    test("Ensure command is registered", () => {
        ...
        commandManager.verify(
            c =>
                c.registerCommand(
                    TypeMoq.It.isValue(Commands.Start_REPL),
                    TypeMoq.It.isAny(),
                    TypeMoq.It.isAny()
                ),
            TypeMoq.Times.once()
        ...
        serviceContainer.verify(
            c =>
                c.get(
                    ...
                    TypeMoq.It.isValue("repl")
                ),
            TypeMoq.Times.once()
        );
        codeExecutionService.verify(
            c => c.initializeRepl(TypeMoq.It.isValue(undefined)),
            TypeMoq.Times.once()
        );
    });
    ...
    test("Ensure resource is uri of the active document", () => {
        ...
        codeExecutionService.verify(
            c => c.initializeRepl(TypeMoq.It.isValue(documentUri)),
            TypeMoq.Times.once()
        );
    });
    ...
    test("Ensure first available workspace folder is used if there no document", () => {
        ...
        codeExecutionService.verify(
            c => c.initializeRepl(TypeMoq.It.isValue(workspaceUri)),
            TypeMoq.Times.once()
        );
    });
});
