...
suite("Workspace Symbols Generator", () => {
    ...
    setup(() => {
        ...
        factory
            ...
            .returns(() => Promise.resolve(instance(processService)));
    ...
    test("Throw error when generating tags", async () => {
        ...
        when(
            processService.execObservable(ctagsPath, anything(), anything())
