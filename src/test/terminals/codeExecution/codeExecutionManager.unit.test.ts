...
suite("Terminal - Code Execution Manager", () => {
    ...
    test("Ensure commands are registered", async () => {
        ...
        commandManager.verify(
            c =>
                c.registerCommand(
                    TypeMoq.It.isValue(Commands.Exec_In_Terminal),
                    TypeMoq.It.isAny()
                ),
            TypeMoq.Times.once()
        );
        commandManager.verify(
            c =>
                c.registerCommand(
                    TypeMoq.It.isValue(Commands.Exec_Selection_In_Terminal),
                    TypeMoq.It.isAny()
                ),
            TypeMoq.Times.once()
        );
        commandManager.verify(
            c =>
                c.registerCommand(
                    TypeMoq.It.isValue(Commands.Exec_Selection_In_Django_Shell),
                    TypeMoq.It.isAny()
                ),
            TypeMoq.Times.once()
        );
    ...
    test("Ensure executeFileInterTerminal will do nothing if no file is avialble", async () => {
        ...
        expect(commandHandler).not.to.be.an(
            "undefined",
        ...
        serviceContainer
            .setup(s => s.get(TypeMoq.It.isValue(ICodeExecutionHelper)))
    ...
    test("Ensure executeFileInterTerminal will use provided file", async () => {
        ...
        serviceContainer
            .setup(s =>
                s.get(
                    TypeMoq.It.isValue(ICodeExecutionService),
                    TypeMoq.It.isValue("standard")
                )
            )
        ...
        executionService.verify(
            async e => e.executeFile(TypeMoq.It.isValue(fileToExecute)),
            TypeMoq.Times.once()
        );
    });
    ...
    test("Ensure executeFileInterTerminal will use active file", async () => {
        ...
        serviceContainer
            ...
            .returns(() => helper.object);
        helper
            .setup(async h => h.getFileToExecute())
    ...
    async function testExecutionOfSelectionWithoutAnyActiveDocument(
        commandId: string,
        executionSericeId: string
    ) {
        let commandHandler: undefined | (() => Promise<void>);
        // tslint:disable-next-line:no-any
        commandManager.setup(c => c.registerCommand).returns(() => {
        ...
        serviceContainer
            .setup(s =>
                s.get(
                    TypeMoq.It.isValue(ICodeExecutionService),
                    TypeMoq.It.isValue(executionSericeId)
                )
            )
            .returns(() => executionService.object);
    ...
    async function testExecutionOfSlectionWithoutAnythingSelected(
        commandId: string,
        ...
        serviceContainer
            ...
            .returns(() => helper.object);
        helper
            .setup(h => h.getSelectedTextToExecute)
        ...
        serviceContainer
            .setup(s =>
                s.get(
                    TypeMoq.It.isValue(ICodeExecutionService),
                    TypeMoq.It.isValue(executionServiceId)
                )
            )
            .returns(() => executionService.object);
        // tslint:disable-next-line:no-any
    ...
    test("Ensure executeSelectionInTerminal will do nothing if no text is selected", async () => {
        await testExecutionOfSlectionWithoutAnythingSelected(
            Commands.Exec_Selection_In_Terminal,
            "standard"
        );
    });
    ...
    async function testExecutionOfSelectionIsSentToTerminal(
        commandId: string,
        executionServiceId: string
    ) {
        let commandHandler: undefined | (() => Promise<void>);
        ...
        documentManager
            ...
            .returns(() => activeEditor.object);

        await commandHandler!();
        executionService.verify(
            async e =>
                e.execute(
                    TypeMoq.It.isValue(textSelected),
                    TypeMoq.It.isValue(activeDocumentUri)
                ),
            TypeMoq.Times.once()
        );
        helper.verifyAll();
    ...
    test("Ensure executeSelectionInTerminal will normalize selected text and send it to the terminal", async () => {
        await testExecutionOfSelectionIsSentToTerminal(
            Commands.Exec_Selection_In_Terminal,
            "standard"
        );
    });
