...
//
export const PYTHON_VIRTUAL_ENVS_LOCATION =
    process.env.PYTHON_VIRTUAL_ENVS_LOCATION;
...
export const MOCHA_CI_REPORTFILE: string =
    MOCHA_REPORTER_JUNIT && process.env.MOCHA_CI_REPORTFILE !== undefined
        ? process.env.MOCHA_CI_REPORTFILE
        : "./junit-out.xml";
export const MOCHA_CI_PROPERTIES: string =
    MOCHA_REPORTER_JUNIT && process.env.MOCHA_CI_PROPERTIES !== undefined
        ? process.env.MOCHA_CI_PROPERTIES
        : "";
export const MOCHA_CI_REPORTER_ID: string =
    MOCHA_REPORTER_JUNIT && process.env.MOCHA_CI_REPORTER_ID !== undefined
        ? process.env.MOCHA_CI_REPORTER_ID
        : "mocha-junit-reporter";
export const IS_CI_SERVER_TEST_DEBUGGER =
