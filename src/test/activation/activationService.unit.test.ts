...
suite("Activation - ActivationService", () => {
    [true, false].forEach(jediIsEnabled => {
        suite(`Jedi is ${jediIsEnabled ? "enabled" : "disabled"}`, () => {
            ...
            let lanagueServerSupportedService: TypeMoq.IMock<
                ILanguageServerCompatibilityService
            >;
            let lsNotSupportedDiagnosticService: TypeMoq.IMock<
                IDiagnosticsService
            >;
            setup(() => {
                ...
                lanagueServerSupportedService = TypeMoq.Mock.ofType<
                    ILanguageServerCompatibilityService
                >();
                ...
                serviceContainer
                    .setup(c => c.get(TypeMoq.It.isValue(IDisposableRegistry)))
                    .returns(() => []);
                serviceContainer
                    .setup(c =>
                ...
                serviceContainer
                    .setup(c =>
                        c.get(TypeMoq.It.isValue(ILanguageServerFolderService))
                    )
            ...
            async function testActivation(
                ...
                activator: TypeMoq.IMock<IExtensionActivator>,
                ...
                serviceContainer
                    .setup(c =>
                        c.get(
                            ...
                            TypeMoq.It.isValue(activatorName)
                        )
                    )
            ...
            test("LS is supported", async () => {
                lanagueServerSupportedService
                    .setup(ls => ls.isSupported())
                    .returns(() => Promise.resolve(true));
                pythonSettings
                    .setup(p => p.jediEnabled)
                    .returns(() => jediIsEnabled);
            ...
            test("Prompt user to reload VS Code and reload, when setting is toggled", async () => {
                ...
                pythonSettings
                    .setup(p => p.jediEnabled)
                    .returns(() => jediIsEnabledValueInSetting);
                const activator = TypeMoq.Mock.ofType<IExtensionActivator>();
                const activationService = new ExtensionActivationService(
                    serviceContainer.object
                );
                ...
                event
                    .setup(e =>
                        e.affectsConfiguration(
                            TypeMoq.It.isValue("python.jediEnabled"),
                            TypeMoq.It.isAny()
                        )
                    )
                    .returns(() => true)
                ...
                cmdManager
                    .setup(c =>
                        c.executeCommand(
                            TypeMoq.It.isValue("workbench.action.reloadWindow")
                        )
                    )
                    .verifiable(TypeMoq.Times.once());
                ...
                test("Revert to jedi when LS activation fails", async () => {
                    ...
                    serviceContainer
                        .setup(c =>
                            c.get(
                                TypeMoq.It.isValue(IExtensionActivator),
                                TypeMoq.It.isValue(ExtensionActivators.DotNet)
                            )
                        )
                    ...
                    serviceContainer
                        .setup(c =>
                            c.get(
                                TypeMoq.It.isValue(IExtensionActivator),
                                TypeMoq.It.isValue(ExtensionActivators.Jedi)
                            )
                        )
